...
class CobSeafoodShopCheckoutLight extends React.Component<Props, States> {
    ...
    constructor(props: Props) {
        super(props);
        this.state = {
            activeStep: 1, completed: 0, enterBilling: false, shippingMethod: -1, date: 0, open: false, termsRead: false, acceptBail: false, acceptTerms: false, firstName: "", lastName: "", address: ""
        }
        this.totalPriceInclFees = this.roundMoney(this.props.totalPrice * 1.08);
    }
        ...
        return (
            <>
                ...
                <div className='HW2-Cart-Checkout'>
                    <h2>PLEASE REVIEW YOUR CART</h2>
                    <Divider></Divider>
                    <div>
                        <div className='HW2-Cart-List'>
                            {this.getCartList()}</div>
                    </div>
                    <div className='HW2-Price-Checkout'>

                        <Segment >
                            <Grid columns={1} relaxed="very">
                                <Grid.Column>
                                    Price: ${this.props.totalPrice} <br />
                                    Tax (8%): + ${this.roundMoney(this.totalPriceInclFees - this.props.totalPrice)} <br />
                                    <Divider></Divider>
                                ...
                                <Grid.Column>
                                    {this.state.activeStep == 3 && <>
                                        <div className='HW2-Final-Confirmation-Form'>
                                            ...
                                            />
                                            <div
                                                className="HW2-Link" onClick={() => this.setState({ open: true })}><a>PLEASE READ THE TERMS HERE BEFORE AGREEING</a></div>
                                            <Checkbox
                                        ...
                                        <ButtonGroup>
                                            ...
                                            {(this.state.acceptBail && this.state.acceptTerms) && <>
                                                <a href="/HW2light/success"><Button size='huge' color='blue' animated onClick={() => {
...
export default CobSeafoodShopCheckoutLight;
