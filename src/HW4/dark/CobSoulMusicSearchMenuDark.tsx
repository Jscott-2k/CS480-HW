...
import { CobSoulMusicFilters } from './CobSoulMusicDark';
import { ModifierFlags } from 'typescript';

interface CobSoulMusicSearchMenuDarkProps {
    lastFiler:CobSoulMusicFilters,
    onUpdate:(filter:CobSoulMusicFilters)=>void
    darkMode:boolean
}

export default function CobSoulMusicSearchMenuDark(props: CobSoulMusicSearchMenuDarkProps) {
    return (
        <>
