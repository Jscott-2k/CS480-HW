...
interface CobSoulMusicSignInTosLightProps {
    openUp: boolean
    onClose:()=>void
}

interface  CobSoulMusicSignInTosLightStates {
    openUp: boolean
    termsRead:boolean
}
export default class  CobSoulMusicSignInTosLight extends React.Component<CobSoulMusicSignInTosLightProps, CobSoulMusicSignInTosLightStates>{
    constructor(props: CobSoulMusicSignInTosLightProps) {
        super(props);
        this.state = {
            openUp:false,
            termsRead:false
            ...
            <>
                ...
                >
                    ...
                    <Modal.Content scrolling>
                        <Modal.Description>
                            <div className='HW4-TermsDark HW4-Bolder'>
                                <p>
