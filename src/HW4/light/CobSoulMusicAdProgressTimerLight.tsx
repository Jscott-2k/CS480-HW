...
interface CobSoulMusicAdProgressTimerLightProps{
    initalTime:number,
    updateTick:number,
    onFinish:()=>void
}

export default function CobSoulMusicAdProgressTimerLight(props:CobSoulMusicAdProgressTimerLightProps){
    ...
    useEffect(() => {
      ...
      return (
        ...
        <div className='HW4-Bolder HW4-Larger'>
