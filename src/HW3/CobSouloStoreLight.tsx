...
import CobSouloStoreItemLight from './CobSouloStoreItemLight';
...
interface States {
    ...
    currencyUSDDisplay: boolean,
    action: () => void
}

class CobSouloStoreLight extends Component<Props, States> {
    ...
    constructor(props: Props) {
        super(props);
        this.state = {
            open: false, name: "", price: 0, currency: "", action: () => { }, successOpen: false, imgSrc: "string", convertionFailOpen: false, convertionSuccessOpen: false, currencyUSDDisplay: false
        }
            ...
            <>
                <div className='HW3SoulStoreContainer'>
                    ...
                    <div className='HW3SoulStore'>
                        <br></br>
                        <CobSouloCobuckCountLight as="row"></CobSouloCobuckCountLight>
                        {!this.props.recharge &&
                            <div className="HW3StoreOutsideButton">
                                <Button inverted size="huge" onClick={() => this.setState({ currencyUSDDisplay: !this.state.currencyUSDDisplay })}>
                                    {!this.state.currencyUSDDisplay && <>SHOW approximate USD prices</>
                                    }
                                    {this.state.currencyUSDDisplay &&
                                        <> HIDE approximate USD prices</>
                                    }
                                </Button></div>
                        }
                        ...
                        <Card.Group centered>
                            ...
                            {this.props.recharge && <>
                                ...
                                <CobSouloStoreItemLight name="5 Gold Cobucks" price={6} onBuyClick={this.readyPurchase} imgSrc="./gold1.png" currency="usd" dailyBonus={true} action={() => {
                                    let newUser = user;
                                ...
                                } } sale={false} saleRed={0} bonusDesc="3 Silver" approxUSDDisplay={this.state.currencyUSDDisplay} />


                                <CobSouloStoreItemLight name="10 Gold Cobucks" price={11} onBuyClick={this.readyPurchase} imgSrc="./gold0.jpg" currency="usd" action={() => {
                                    setGold(wealth.gold + 10);
                                }} sale={false} saleRed={0} approxUSDDisplay={this.state.currencyUSDDisplay}/>
                                <CobSouloStoreItemLight name="100 Gold Cobucks" price={91} onBuyClick={this.readyPurchase} imgSrc="./gold3.jpg" currency="usd" action={() => {
                                    setGold(wealth.gold + 100);
                                }} sale={false} saleRed={0} bestValue={true} approxUSDDisplay={this.state.currencyUSDDisplay}/>
                            ...
                            {!this.props.recharge && <>
                                ...
                                <CobSouloStoreItemLight name="1,000 souls" price={4} onBuyClick={this.readyPurchase} imgSrc="./ghost.gif" currency="silver" action={() => {
                                    // setGold(wealth.gold - 63);
                                    // setSouls(souls+100000);
...
export default CobSouloStoreLight;
